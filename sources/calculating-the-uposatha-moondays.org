...
- code sample for the 1288 AD example for the luni-solar calendar section
...
\resizebox{\linewidth}{!}{\DuangChata{ {0}{0}{0} }{ {1}{0}{0} }}
...
- Tithi\footnote{a.k.a. Thaloengsok or New Year's Day} \thai{ดีถี} :: Age of the Moon, at the start of the year if $\mathbf{day} = 1$ 
...
- MeanSun, TrueSun, MeanMoon, TrueMoon :: Mean and True position of the Sun and the Moon
- Raek :: The position of the Moon in the 27 mansions (Naksatra, \thai{นักษัตร}) of the Zodiac, which will determine the month
...
Ephemeris p.19: Rasi and angsa, signs and degrees: 30 degrees to each rasi. Aries=0. 107 degrees = 3:17
