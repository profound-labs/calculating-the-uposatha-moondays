...
This is in Calendrical page 2 footnote. Add all three examples here, with Golang to compute the same result from the Gregorian date.
...
of the /Chulasakkarat Era/.\cite{eade1995calendrical}
...
years.\cite{eade1995calendrical}
