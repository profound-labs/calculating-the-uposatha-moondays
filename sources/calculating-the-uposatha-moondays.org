...
- Tithi\footnote{a.k.a. Thaloengsok or New Year's Day} :: Age of the Moon, at the start of the year if $\mathbf{day} = 1$ 
...
- Raek\footnote{a.k.a. Naksatra} :: The position of the Moon in the 27 mansions
...
# Keep a \clearpage before "Names of the months" section to preserve sensible pagegreaks.
\clearpage
...
p.27: naksatra: which the moon will occupy at full moon

p.31: raek: the reference is to the 27 segments into which the moon's orbit is divided

each segment is 13 deg 20 min

p.34: The names of the lunar months are derived from the name of naksatra that the
