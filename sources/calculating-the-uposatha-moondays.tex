...
\item[{Avoman \thai{อวมาน}}] used for the Moon's mean motion
\item[{Tithi\footnote{a.k.a. Thaloengsok or New Year's Day} \thai{ดีถี}}] age of the Moon, from 0-29
\end{description}

As we follow the steps, we will also obtain:

\begin{description}
\item[{Horakhun \thai{อหรคุณ}}] day index, or elapsed days of the era
...
\href{http://horoscope.thaiorc.com/calendar/thaicalendar.php?y=2558}{horoscope.thaiorc.com - 2015 - \thai{ปฏิทิน 150 ปี ปฏิทินจันทรคติ ปฏิทินสุริยคติ}}
