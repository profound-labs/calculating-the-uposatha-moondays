...
\legend{\Delta M: years since the last adhikamāsa. nM: position in the 19-year cycle. \Delta V: years since the last adhikamāsa. nV: position in the 57-year cycle. 'x' marks years which would qualify for adhikavāra, but there is already an adhikamāsa, and so the adhikavāra shifts to the following year.}
\begin{multicols}{2}
...
\item[{Tithi}] Age of the moon at the start of the year\footnote{a.k.a. Thaloengsok or New Year's Day}
\end{description}
...
\item[{Raek}] raek\footnote{a.k.a. Naksatra}
\end{description}
...
\href{https://github.com/splendidmoons/suriya-go}{suriya-go} we can write the following Golang code:
