...
\item[{Tithi\footnote{a.k.a. Thaloengsok or New Year's Day} \thai{ดีถี}}] Age of the Moon, at the start of the year if $\mathbf{day} = 1$
\end{description}
...
\item[{Raek}] The position of the Moon in the 27 mansions (Nakshatra, \thai{นักษัตร}) of the Zodiac, which will determine the month
\end{description}
...
\resizebox{\linewidth}{!}{\DuangChata{ {2}{0}{0} }{ {7}{0}{0} }}
