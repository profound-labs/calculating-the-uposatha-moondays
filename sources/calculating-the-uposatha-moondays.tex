...
\item The lunar year starts at the spring equinox in April with Citta month, Hot
...
\begin{description}
\item[{3 pages}] To understand how to construct a given year's uposathas, see
...
\item[{+4 pages}] A given day is visualized with the zodiac wheel diagrams
(a.k.a \emph{duang chata}). Making sense of these is in sec. \ref{duangchata},
...
\section{Year Types and lengths}
\label{sec-3-4}
